...
const SearchBar = ({ data, filterColumns, handleFilterData, className }) => {
  ...
  const searchByParameter = (
    ...
    const filteredData = data.filter((dataPoint) =>
      dataPoint[filterColumns[searchColumn].name].includes(searchParameter)
    );
  ...
  useEffect(() => {
    ...
    setFilterParameter(searchFilter);
    setFilteredData(
      searchByParameter(data, filterColumns, filterBy, filterParameter)
    );
  }, [filterByValue, searchFilter]);
