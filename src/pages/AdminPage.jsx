        ...
        <div className={style.sideA}>
          <div className={style.sideMenu}>
            ...
            <ul className={style.sideMenuItems}>
              <li className={`${style.sideMenuItem} ${view === 1 ? style.selected : ""}`} onClick={() => navigate("/admin/usuarios")}>
              ...
              <li className={`${style.sideMenuItem} ${view === 2 ? style.selected : ""}`} onClick={() => navigate("/admin/turnos")}>
              ...
              <li className={`${style.sideMenuItem} ${view === 3 ? style.selected : ""}`} onClick={() => navigate("/admin/mensajes")}>
              ...
              <li className={`${style.sideMenuItem} ${view === 4 ? style.selected : ""}`} onClick={() => navigate("/admin/servicios")}>
